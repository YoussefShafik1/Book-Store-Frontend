...
export class CheckoutFormComponent implements OnInit {
  ...
  async ngOnInit() {
    this.stripe = await loadStripe(
      'pk_test_51QpOgoP85Ow2USMIZI8bIJ88PT6MmV6CaqUOGq27bguCEytdgML1FlV4kggEjcMz2z3BsiSzWlJFphNo64K0yBrm00mFYVqNg8'
    );
    ...
    this.cartService
      ...
      .subscribe((cartData: { items: any[]; totalAmount: number }) => {
  ...
  createOrder() {
    this.cartService
      .createPaymentIntent(this.totalAmount)
